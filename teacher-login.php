...
<head>
    ...
    <title><?php echo $appName ?> | Teacher Login</title>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"><?= $appName ?> | Teacher Login</h1>
                            </div>
                   ...
                   Don't Have an Account?<a href="teacher-register.php">Sign up Here</a>
