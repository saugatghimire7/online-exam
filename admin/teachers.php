                ...
                <tbody>
                    <?php foreach ($teachers as  $i => $teacher) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= $baseUrl ?>/admin/teacher-form.php?teacher_id=<?= $teacher['id'] ?>" class="btn btn-success">
                                    <i class="fas fa-edit"></i>
                                    <span>Edit</span>
                                </a>
                                <form class="d-inline-block" action="<?= $baseUrl ?>/admin/teacher-delete.php" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
